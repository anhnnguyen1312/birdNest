  ...
  return (
    <div>
      <div className="flex-1">
        {/* <!-- PageHeading --> */}
        <div className="mb-6">
          <h1 className="text-3xl font-extrabold tracking-tight text-text-main dark:text-white lg:text-4xl">
            Lịch Sử Đơn Hàng
          </h1>
          <p className="mt-1 text-text-subtle dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
          ...
          <div className="flex flex-col gap-4 xl:col-span-1">
            ...
            <div className="relative">
              <span className="material-symbols-outlined pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-text-subtle">
                search
              </span>
              <input
                className="w-full rounded-lg border border-gray-200 bg-surface-light py-2.5 pl-10 pr-4 text-sm text-text-main placeholder:text-text-subtle focus:border-primary focus:ring-primary dark:border-gray-700 dark:bg-surface-dark dark:text-gray-200"
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-surface-light px-4 text-sm font-medium text-text-main hover:bg-gray-200 dark:bg-surface-dark dark:text-gray-300 dark:hover:bg-gray-700">
                Chờ xử lý
              </button>
              <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-surface-light px-4 text-sm font-medium text-text-main hover:bg-gray-200 dark:bg-surface-dark dark:text-gray-300 dark:hover:bg-gray-700">
                Đang giao
          ...
          <div className="rounded-lg border border-gray-200/80 p-6 xl:col-span-2 dark:border-gray-700/80 dark:bg-surface-dark">
            ...
            <div className="py-6">
              ...
              <ol className="mt-2 grid grid-cols-4 text-center text-xs font-medium text-text-subtle dark:text-gray-400">
            ...
            <div className="grid grid-cols-1 gap-6 border-t border-gray-200 pt-6 sm:grid-cols-2 dark:border-gray-700">
              {/* <!-- Customer Info --> */}
              <div>
                <h3 className="mb-2 text-base font-semibold text-text-main dark:text-white">
                ...
                <p className="mt-1 text-sm text-text-subtle dark:text-gray-300">
            ...
            <div className="mt-6 border-t border-gray-200 pt-6 dark:border-gray-700">
              <h3 className="mb-4 text-base font-semibold text-text-main dark:text-white">
                Sản phẩm đã đặt
              </h3>
            ...
            <div className="mt-6 space-y-2 border-t border-gray-200 pt-6 dark:border-gray-700">
              <div className="flex justify-between text-sm text-text-subtle dark:text-gray-300">
            ...
            <div className="mt-6 flex flex-wrap gap-3 border-t border-gray-200 pt-6 dark:border-gray-700">
              ...
              <button className="flex h-11 flex-1 items-center justify-center gap-2 rounded-lg border border-gray-300 bg-background-light px-5 text-sm font-bold text-text-main hover:bg-surface-light dark:border-gray-600 dark:bg-surface-dark dark:text-gray-200 dark:hover:bg-gray-700">
